...
export const TERMS_AND_CONDITIONS = [
  'Pesanan yang sudah dikerjakan tidak dapat dibatalkan.',
  'Pengambilan melewati estimasi akan dikenakan biaya sewa Rp 2.000/hari.',
  'Barang hilang atau rusak karena kesalahan kami akan diganti max 3x harga laundry.',
  'Simpan struk ini sebagai bukti pengambilan.',
  'Konfirmasi pembayaran ke kasir sebelum pengambilan.',
];
